...
const parsedSvg = parseSvg(rawSvg);
...
svg.setAttribute("width", "155px");
svg.setAttribute("height", "109px");
svg.setAttribute("viewBox", parsedSvg.attributes["viewBox"]);

const group = document.createElementNS("http://www.w3.org/2000/svg", "g");
group.setAttribute("transform", parsedSvg.children[1].attributes["transform"]);

const path = document.createElementNS("http://www.w3.org/2000/svg", "path");
path.setAttribute("d", parsedSvg.children[1].children[0].attributes["d"]);
path.setAttribute("transform", parsedSvg.children[1].children[0].attributes["transform"]);
path.setAttribute("style", "fill-rule: evenodd"); // crucial
